...
(function() {
  ...
  Waveform = (function() {
    'use strict';
    var BUS_SIGNAL, CANVAS_MAX_HEIGHT, DEFAULT_COLOR, DEFAULT_OPACITY, GRID_SECTIONS, RADIX_BIN, RADIX_DEC, RADIX_HEX, RULER_HEIGHT, SIGNAL_BOX_HEIGHT, SIGNAL_BOX_PADDING, SIGNAL_BOX_WIDTH, SIGNAL_BUS_SLOPE, SIGNAL_HEIGHT, SIGNAL_NAMES_BOX_WIDTH, SIGNAL_NAME_WIDTH, WIRE_SIGNAL, confirmationDialog;
            ...
            return function() {
              ...
              for (l = 0, len2 = selectionIds.length; l < len2; l++) {
                ...
                if (node && node.type === 'leaf') {
                  ...
                  if (indexOf.call(_this.includedSignals, selectionName) < 0) {
    ...
    Waveform.prototype.removeSignal = function() {
      ...
      confirmationDialog.bind(this)(dialogTitle, dialogMessage, (function(_this) {
